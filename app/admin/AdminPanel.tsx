    ...
    return (
      <section className="adminLoginGate">
        <form className="adminLogin adminLoginCompact gateCard" onSubmit={login}>
          <label>
            <span>Email</span>
            <input name="email" id="email" type="email" autoComplete="username" value={email} onChange={(event) => setEmail(event.target.value)} />
          </label>
          <label>
            <span>Password</span>
            <div className="passwordInputWrapper">
              <input name="password" id="password" type={showPassword ? "text" : "password"} autoComplete="current-password" value={password} onChange={(event) => setPassword(event.target.value)} />
              <button 
                type="button" 
